...
export const MOCK_DISHES: IDish[] = [
  // ===== 羊肉类 =====
  { id: 'l1', name: '羊肉串', price: 50, description: '鲜嫩多汁，孜然飘香', category: 'lamb', tags: ['招牌', '人气'], emoji: '🍢', spec: '15-16串', baseQuantity: 60 },
  { id: 'l2', name: '羊肉筋', price: 45, description: '筋道有嚼劲，越嚼越香', category: 'lamb', tags: ['推荐'], emoji: '🥩', spec: '15-16串' },
  { id: 'l3', name: '羊腰', price: 65, description: '滋补鲜嫩，炭火炙烤', category: 'lamb', tags: ['滋补'], emoji: '🍢', spec: '5-6串', baseQuantity: 10 },
  ...
  { id: 'l9', name: '羊肝', price: 25, description: '鲜嫩不膻，补铁佳品', category: 'lamb', tags: [], emoji: '🍢', spec: '10-12串', baseQuantity: 10 },
  // ===== 牛肉类 =====
  { id: 'b1', name: '牛肉串', price: 45, description: '肉质紧实，肉汁饱满', category: 'beef', tags: ['人气'], emoji: '🍢', spec: '15-16串', baseQuantity: 15 },
  { id: 'b2', name: '牛板筋(熟)', price: 55, description: '软糯带筋，越嚼越香', category: 'beef', tags: ['推荐'], emoji: '🍢', spec: '15-16串', baseQuantity: 10 },
  { id: 'b3', name: '牛心管(熟)', price: 80, description: '爽脆弹牙，烧烤经典', category: 'beef', tags: ['招牌'], emoji: '🍢', spec: '11-12串' },
  { id: 'b4', name: '牛腰子', price: 40, description: '炭烤焦香，风味浓郁', category: 'beef', tags: [], emoji: '🍢', spec: '10-11串', baseQuantity: 10 },
  ...
  // ===== 鸡肉类 =====
  { id: 'c1', name: '鸡翅(原味)', price: 35, description: '外皮焦香，肉质嫩滑', category: 'chicken', tags: ['人气'], emoji: '🍗', spec: '7-8串', baseQuantity: 15 },
  ...
  { id: 'c4', name: '鸡心', price: 25, description: '鲜嫩弹牙，炭香四溢', category: 'chicken', tags: [], emoji: '🍢', spec: '9-10串', baseQuantity: 15 },
  { id: 'c5', name: '鸡软骨', price: 50, description: '嘎嘣脆，越嚼越香', category: 'chicken', tags: ['推荐'], emoji: '🍢', spec: '13-14串' },
  { id: 'c6', name: '鸡肉串', price: 25, description: '嫩滑多汁，老少皆宜', category: 'chicken', tags: [], emoji: '🍢', spec: '10-11串', baseQuantity: 15 },
  ...
  { id: 'o2', name: '鱿鱼', price: 5, description: '鲜香弹牙，烧烤海鲜', category: 'other', tags: ['海鲜'], emoji: '🦑', spec: '串', baseQuantity: 5 },
  ...
  { id: 's2', name: '孜然(大)', price: 10, description: '烧烤灵魂调料', category: 'seasoning', tags: ['调料'], emoji: '🧂', spec: '袋', baseQuantity: 1 },
  { id: 's3', name: '辣椒(小)', price: 5, description: '香辣过瘾', category: 'seasoning', tags: ['辣', '调料'], emoji: '🌶️', spec: '袋' },
  { id: 's4', name: '辣椒(大)', price: 10, description: '香辣过瘾', category: 'seasoning', tags: ['辣', '调料'], emoji: '🌶️', spec: '袋', baseQuantity: 1 },
  ...
  { id: 's10', name: '盐', price: 3, description: '基础调味', category: 'seasoning', tags: ['调料'], emoji: '🧂', spec: '袋', baseQuantity: 1 },
  ...
  { id: 't3', name: '酒精', price: 2, description: '点火助燃', category: 'tools', tags: ['耗材'], emoji: '🔥', spec: '瓶', baseQuantity: 3 },
  ...
  { id: 't10', name: '扇子', price: 5, description: '扇火助燃', category: 'tools', tags: ['用具'], emoji: '🪭', spec: '把', baseQuantity: 1 },
  { id: 't11', name: '木炭', price: 10, description: '经典木炭', category: 'tools', tags: ['耗材'], emoji: '🪵', spec: '袋', baseQuantity: 1 },
